...
- [Connection in a network](#connection-in-a-network)
- [Speed of the Internet](#speed-of-the-internet)
- [IPv4 address](#ipv4-address)
- [Static IP address](#static-ip-address)
- [Dynamic IP address](#dynamic-ip-address)
- [DHCP](#dhcp)
  - [What is DHCP](#what-is-dhcp)
  - [Component of DHCP scope](#component-of-dhcp-scope)
  - [How DHCP works](#how-dhcp-works)
- [Public vs private IP address](#public-vs-private-ip-address)
...
|---------|---------|---------|
| Produce upto 16 million host -> Use for organization with very large ammount of host (Eg: ISP) | Produce upto 65,000 hosts -> Use for medium to large organization | Produce up to 254 host (Because all 1s or 0s are used for broadcasting) |
| First bit: 0 | First 2 bits: 10 | First 3 bits: 110
| First octet: 1 - 126 | First octet: 128 - 191 | First octet: 192 - 223
